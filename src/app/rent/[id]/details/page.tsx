        ...
        <section>
          <div className="mt-6 border">
            ...
            <div className="overflow-x-scroll sm:overflow-auto">
              <div className="flex w-[550px] items-start justify-around gap-8 p-4 sm:w-full sm:gap-12">
                {rent.data.status === "Rent_Canceled" ? (
                  <div
                    className={cn("flex flex-col items-center justify-center gap-2 text-red-700")}
                  >
                    <X size={36} />
                  ...
                  <div
                    className={cn("flex flex-col items-center justify-center gap-2 text-green-500")}
                  >
                    <Box size={36} />
                    <div className="text-center">
                ...
                {rent.data.status === "Rent_Expired" ? (
                  <div
                    className={cn("flex flex-col items-center justify-center gap-2 text-red-500")}
                  >
                    <Clock size={36} />
                    <div className="text-center">
                  ...
                  >
                    ...
                    <div className="text-center">
                      <p className="text-xs font-semibold">
                        {ERentStatus.Rent_Finished} com Atraso
                      </p>
                      <p className="text-xs">
